...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      social: [{ icon: 'github', label: 'GitHub', href: 'https://github.com/hiddenpath' }],
      sidebar: [
        {
          ...
          items: [
            {
              label: 'Introduction',
              translations: { 'zh-CN': '简介', ja: 'はじめに', es: 'Introducción' },
              slug: 'intro',
            },
            {
              label: 'Quick Start',
            ...
            },
            {
              ...
              translations: {
                'zh-CN': '生态系统架构',
                ja: 'エコシステムアーキテクチャ',
                es: 'Arquitectura del ecosistema',
              },
              slug: 'ecosystem',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'Specification',
              translations: { 'zh-CN': '规范', ja: '仕様', es: 'Especificación' },
              slug: 'protocol/spec',
            },
            {
              label: 'Provider Manifests',
              translations: {
                'zh-CN': '供应商清单',
                ja: 'プロバイダーマニフェスト',
                es: 'Manifiestos de proveedores',
              },
              slug: 'protocol/providers',
            },
            {
            ...
            {
              label: 'Contributing Providers',
              translations: {
                'zh-CN': '贡献供应商',
                ja: 'プロバイダーの貢献',
                es: 'Contribuir proveedores',
              },
              slug: 'protocol/contributing',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          translations: {
            'zh-CN': '开发者指南',
            ja: '開発者ガイド',
            es: 'Guías para desarrolladores',
          },
          items: [
            {
              label: 'Chat Completions',
              translations: { 'zh-CN': '对话补全', ja: 'チャット補完', es: 'Chat Completions' },
              slug: 'guides/chat',
            },
            {
              label: 'Function Calling',
              translations: { 'zh-CN': '函数调用', ja: '関数呼び出し', es: 'Llamada de funciones' },
              slug: 'guides/tools',
            },
            {
              ...
              translations: {
                'zh-CN': '推理模型',
                ja: '推論モデル',
                es: 'Modelos de razonamiento',
              },
              slug: 'guides/reasoning',
            },
            {
              label: 'Multimodal',
              translations: { 'zh-CN': '多模态', ja: 'マルチモーダル', es: 'Multimodal' },
              slug: 'guides/multimodal',
            },
            {
              label: 'Observability',
              translations: { 'zh-CN': '可观测性', ja: 'オブザーバビリティ', es: 'Observabilidad' },
