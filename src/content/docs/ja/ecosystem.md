...
AI-Lib エコシステムは、各レイヤーが明確な責務を持つクリーンな 3 層アーキテクチャで構築されています。現在のバージョン：**AI-Protocol v0.8.4**（`@ailib-official/ai-protocol`）、**ai-lib-rust v0.9.6**、**ai-lib-python v0.8.5**、**ai-lib-ts v0.5.3**、**ai-lib-go v0.6.0**、**ai-protocol-mock v0.1.11**。
