...
AI-Lib エコシステムは、各レイヤーが明確な責務を持つクリーンな 3 層アーキテクチャで構築されています。現在のバージョン：**AI-Protocol v1.0.0**（`@ailib-official/ai-protocol`）、**ai-lib-rust v1.0.1**、**ai-lib-python v1.0.0**、**ai-lib-ts v1.0.0**、**ai-lib-go v1.0.0**、**ai-protocol-mock v1.0.1**。
