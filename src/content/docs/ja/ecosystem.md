---
title: エコシステムアーキテクチャ
description: AI-Protocol、ai-lib-rust、ai-lib-python、ai-lib-ts が統合エコシステムとしてどのように連携するか。
---

# エコシステムアーキテクチャ

AI-Lib エコシステムは、各レイヤーが明確な責務を持つクリーンな 3 層アーキテクチャで構築されています。現在のバージョン：**AI-Protocol v0.8.1**、**ai-lib-rust v0.9.1**、**ai-lib-python v0.8.1**、**ai-lib-ts v0.5.1**、**ai-protocol-mock v0.1.9**。
...
### 2. ランタイムレイヤー — Rust・Python・TypeScript SDK
...
V2 基盤は `v0.8.1` で生成系フルチェーンの運用ガバナンスまで拡張されました：
