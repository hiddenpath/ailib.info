...
AI-Lib エコシステムは、各レイヤーが明確な責務を持つクリーンな 3 層アーキテクチャで構築されています。現在のバージョン：**AI-Protocol v0.8.2**、**ai-lib-rust v0.9.2**、**ai-lib-python v0.8.2**、**ai-lib-ts v0.5.2**、**ai-protocol-mock v0.1.10**。
