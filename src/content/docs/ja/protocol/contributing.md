...
> **V2-alpha 形式**：プロトコル v0.5.0 リリースでは、Ring 1/2/3 マニフェスト構造を持つ v2-alpha プロバイダー形式を導入しています。新規プロバイダーは、標準化されたエラーコード、フィーチャーフラグ、機能拡張のために v2-alpha をオプションで対象にできます。V2 アーキテクチャの詳細は [プロトコル概要](/protocol/overview/) をご覧ください。
