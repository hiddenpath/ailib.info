...
3. **Versión de lanzamiento** (`package.json`) �?SemVer del paquete (actual: **v1.0.0**)

## Arquitectura del protocolo V2

La evolución hasta **v1.0.0** consolida la arquitectura V2 y agrega gates ejecutables de gobernanza para release.
