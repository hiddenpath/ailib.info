...
description: Telemetría, enrutamiento de modelos, embeddings, caché, plugins y salida estructurada en ai-lib-python v1.0.0.
---
...
Instale características opcionales mediante extras pip (v1.0.0+):
