---
title: API AiClient (Python)
description: Guía detallada para usar AiClient, ChatRequestBuilder y tipos de respuesta en ai-lib-python.
---
...
API fluida para construir solicitudes:
...
Todos los errores exponen códigos de error estándar V2 a través de la propiedad `standard_code` (ai-lib-python v1.0.0+):
