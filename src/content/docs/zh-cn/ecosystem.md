---
title: 生态系统架构
description: AI-Protocol、ai-lib-rust、ai-lib-python 与 ai-lib-ts 如何作为一体化生态系统协同工作。
---

# 生态系统架构

AI-Lib 生态系统建立在清晰的三层架构之上，每一层都有明确的职责。当前版本：**AI-Protocol v0.8.1**、**ai-lib-rust v0.9.1**、**ai-lib-python v0.8.1**、**ai-lib-ts v0.5.1**、**ai-protocol-mock v0.1.9**。
...
### 2. 运行时层 — Rust、Python 与 TypeScript SDK
