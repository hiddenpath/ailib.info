...
| 项目 | 角色 | 语言 | 版本 | 分发渠道 |
|---------|------|----------|---------|---------------|
| **[AI-Protocol](/protocol/)** | 规范层 | YAML/JSON | v0.5.0 | GitHub |
| **[ai-lib-rust](/rust/)** | 运行时实现 | Rust | v0.7.1 | [Crates.io](https://crates.io/crates/ai-lib) |
| **[ai-lib-python](/python/)** | 运行时实现 | Python | v0.6.0 | [PyPI](https://pypi.org/project/ai-lib-python/) |
