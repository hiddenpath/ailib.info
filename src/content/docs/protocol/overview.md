...
│  └── V2_MIGRATION_GUIDE.md # V1 â†?V2 migration guide
...
- **L1 Core Protocol** —Message format, standard error codes (E1001â€“E9999), version declaration. All providers must implement this layer.
